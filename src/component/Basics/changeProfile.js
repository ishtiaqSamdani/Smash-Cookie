                            ...
                            <div className="card">
                                <div className="card-body">
                                    <div className="d-flex flex-column align-items-center text-center">
                                        ...
                                        <div className="mt-3">
                                            <h4>Ishtiaq</h4>
                                            <p className="text-secondary mb-1">NashAgri</p>
                                            <p className="text-muted font-size-sm">Mumbai,MH</p>
                                    ...
                                    <ul className="list-group list-group-flush">
                                        <li className="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                            ...
                                            <span className="text-secondary">https://Nashagri.com</span>
                                        </li>
                                        <li className="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                            ...
                                            <span className="text-secondary">Nashagri</span>
                                        </li>
                                        <li className="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                ...
                                <div className="card-body">
                                    <div className="row mb-3">
                                        ...
                                        <div className="col-sm-9 text-secondary">
                                            <input type="text" className="form-control" placeholder="Ishtiaq "/>
								</div>
                                        </div>
                                        <div className="row mb-3">
                                            <div className="col-sm-3">
                                            ...
                                            <div className="col-sm-9 text-secondary">
                                                <input type="text" className="form-control" placeholder="Ishtiaq@example.com"/>
								</div>
                                            </div>
                                            <div className="row mb-3">
                                                <div className="col-sm-3">
                                                ...
                                                <div className="row mb-3">
                                                    ...
                                                    <div className="col-sm-9 text-secondary">
                                                        <input type="text" className="form-control" placeholder="(320) 380-4539"/>
								</div>
                                                    </div>
                                                    <div className="row mb-3">
                                                        <div className="col-sm-3">
                                                        ...
                                                        <div className="col-sm-9 text-secondary">
                                                            <input type="text" className="form-control" placeholder="Mumbai,MH"/>
								</div>
                                                        </div>
                                                        <div className="row">
                                                            <div className="col-sm-3"></div>
                                                            <div className="col-sm-9 text-secondary">
                                                                <input type="button" className="btn btn-primary px-4" value="Save Changes" onClick={()=>toProfile("toprofile")}/>
								</div>
                                                            </div>
                                                        </div>
                                                    </div>
