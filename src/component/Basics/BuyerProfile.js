...
const [home, sethome] = useState("")
    ...
    const toChangeProfile=(change)=>{
        setstate(change)
    }

    if(state==="tochangeprofile"){
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link" aria-current="page" onClick={()=>Home("home")}>Home</a>
        </li>
        <li class="nav-item">
                ...
                <div className="card-body">
                  ...
                  <div className="row">
                    <div className="col-sm-12">
                      <a className="btn btn-info " target="__blank" onClick={()=>toChangeProfile("tochangeprofile")}>Edit</a>
                    </div>
                  </div>
                </div>
              </div>
